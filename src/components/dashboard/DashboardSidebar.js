...
export function DashboardSidebar({
  ...
  return (
    <>
      ...
      <Dialog open={mobileOpen} onOpenChange={onMobileOpenChange} className="student-mobile-nav" labelledBy={`${role}-mobile-nav-title`}>
        <h2 id={`${role}-mobile-nav-title`} className="sr-only">Navigation menu</h2>
        <SidebarBody
          role={role}
          title={title}
          subtitle={subtitle}
